...
public class Iglesia {
    ...
    public Iglesia(String Nomdeiglesia, String Nomdepastor, int Feligreses, int Cedula, int Diezmo, int Pastores) {
    ...
    public void solicitarinfo(){
        ...
        for (int i = 0; i < Feligreses; i++)
            ...
            this.Diezmo = Integer.parseInt(JOptionPane.showInputDialog(null,"Ingrese la cantidad del Diezmo" + (i + 1)));    
    }
